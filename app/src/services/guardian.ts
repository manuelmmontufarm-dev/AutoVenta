...
export async function armarContexto(
  ...
  return [
    ...
    ...(huella.length
      ...
      : []),
    // HECHO DURO para la regla del 1-sep (conv 13615): si este turno mostró
    // las opciones SIN entregar recomendación, el cliente todavía no eligió —
    // un borrador que anuncie o adjunte una cotización es cotizacion_sin_eleccion
    // y la corrección deja las opciones con su menú de preferencia. El dato en
